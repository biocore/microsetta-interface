...
function skipQuestion(ele, skipType="user-input") {
    ...
    if(skipType == "user-input") {
        if(ele.innerHTML == 'Saltar') {
            newState = 'skip';
            ele.innerHTML = 'Mostrar';
        } else {
            newState = 'display';
            ele.innerHTML = 'Saltar';
        }
        ...
        skipSpanElement.innerHTML = 'Mostrar';
        ...
        for(let i = 0; i < element.children.length; i++) {
            if(element.children[i].classList.contains("field-wrap")) {
                ...
                for(let j = 0; j < radioList.children.length; j++) {
                    if(radioList.children[j].innerText == "No especificado") {
        ...
        for(let i = 0; i < element.children.length; i++) {
            if(element.children[i].classList.contains("field-wrap")) {
                ...
                for(let j = 0; j < listbox.children.length; j++) {
                    if(listbox.children[j].innerText == "No especificado") {
        ...
        for(let i = 0; i < element.children.length; i++) {
            if(element.children[i].classList.contains("field-wrap")) {
                ...
                for(let j = 0; j < selectElement.children.length; j++) {
                    if(selectElement.children[j].value == "No especificado") {
    ...
    for (let i = 0; i < group.childNodes.length; i++) {
        ...
        if (theNode.nodeName == "DIV" && theNode.classList.contains("field-wrap")) {
            ...
            for(let j = 0; j < listbox.children.length; j++) {
                ...
                if(checkboxLabelElement.innerText == "No especificado") {
    ...
    for (let i = 0; i < group.childNodes.length; i++) {
        ...
        if (theNode.nodeName == "DIV" && theNode.classList.contains("field-wrap")) {
            ...
            if(newState == "display") {
                ...
                inputElement.value = "No especificado";
    ...
    for (let i = 0; i < group.childNodes.length; i++) {
        ...
        if (theNode.nodeName == "DIV" && theNode.classList.contains("field-wrap")) {
            ...
            if(newState == "display") {
                ...
                theNode.style.display = "none";
                inputElement.innerText = "No especificado";
                vm.methodToUpdate(inputElement.name, true, false);
            }
        }
    }
